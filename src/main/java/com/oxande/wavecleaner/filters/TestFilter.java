 ...
 * and will add the 2 bands then substracting the
 * differences. This is exactly the pending of
 * "Remove vocals".
 * 
 * @author wrey75
 *
...
//	private boolean 			 isPaused;
	 ...
	 */
	public TestFilter( AudioRecordingStream iFileStream )
	{
...
//			}
			...
			// FILTER STARTS ( A VERY BAD ONE)
			channels[0] = (float)(buffer.getSample( 0, bufferOutIndex ) / 8.0
					+ Math.sin(bufferOutIndex * 3.1416 / 2024.0) / 1.0f);
